...
#define LSM303DLHC_I2C_SCK_PIN               ((uint16_t)0x0040)          /* PB.06 */
#define LSM303DLHC_I2C_SCK_GPIO_PORT         GPIOB                       /* GPIOB */
#define LSM303DLHC_I2C_SCK_GPIO_CLK          RCC_AHBPeriph_GPIOB
#define LSM303DLHC_I2C_SCK_SOURCE            ((uint8_t)0x06) //GPIO_PinSource6
#define LSM303DLHC_I2C_SCK_AF                GPIO_AF_4

#define LSM303DLHC_I2C_SDA_PIN               ((uint16_t)0x0080) //GPIO_Pin_7 /* PB.7 */
#define LSM303DLHC_I2C_SDA_GPIO_PORT         GPIOB                       /* GPIOB */
#define LSM303DLHC_I2C_SDA_GPIO_CLK          RCC_AHBPeriph_GPIOB
#define LSM303DLHC_I2C_SDA_SOURCE            ((uint8_t)0x07)//GPIO_PinSource7
#define LSM303DLHC_I2C_SDA_AF                GPIO_AF_4

#define LSM303DLHC_DRDY_PIN                  ((uint16_t)0x0020)   //GPIO_Pin_2 /* PE.02 */
...
#define LSM303DLHC_DRDY_EXTI_PIN_SOURCE      ((uint8_t)0x02) //EXTI_PinSource2
#define LSM303DLHC_DRDY_EXTI_IRQn            EXTI2_TS_IRQn 

#define LSM303DLHC_I2C_INT1_PIN              ((uint16_t)0x0010) //GPIO_Pin_4  /* PE.04 */
...
#define LSM303DLHC_I2C_INT1_EXTI_PIN_SOURCE  ((uint8_t)0x04) //EXTI_PinSource4
#define LSM303DLHC_I2C_INT1_EXTI_IRQn        EXTI4_IRQn 

#define LSM303DLHC_I2C_INT2_PIN              ((uint16_t)0x0020) // GPIO_Pin_5                  /* PE.05 */
...
#define LSM303DLHC_I2C_INT2_EXTI_PIN_SOURCE  ((uint8_t)0x05)  //EXTI_PinSource5
