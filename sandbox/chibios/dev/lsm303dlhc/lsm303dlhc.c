...
static void LSM303DLHC_LowLevel_Init(void)
{
  ...
  _pal_lld_setgroupmode(LSM303DLHC_I2C_SCK_GPIO_PORT, LSM303DLHC_I2C_SCK_AF, LSM303DLHC_I2C_SCK_SOURCE << ALTERNATE_SHIFT);
  _pal_lld_setgroupmode(LSM303DLHC_I2C_SDA_GPIO_PORT, LSM303DLHC_I2C_SDA_AF, LSM303DLHC_I2C_SDA_SOURCE << ALTERNATE_SHIFT);
  ...
  _pal_lld_setgroupmode(GPIOB, LSM303DLHC_I2C_SCK_AF, 0x04 << MODE_SHIFT);
  _pal_lld_setgroupmode(GPIOB, LSM303DLHC_I2C_SCK_AF, 0x00 << OTYPE_SHIFT);
  _pal_lld_setgroupmode(GPIOB, LSM303DLHC_I2C_SCK_AF, 0x02 << PUDR_SHIFT);
  _pal_lld_setgroupmode(GPIOB, LSM303DLHC_I2C_SCK_AF, 0x03 << OSPEED_SHIFT);
  ...
  pal_lld_writepad(GPIOB, LSM303DLHC_I2C_SCK_PIN, GPIO_BSRR_BS_6);

 
  /* I2C SDA pin configuration */
  //GPIO_InitStructure.GPIO_Pin =  LSM303DLHC_I2C_SDA_PIN;
  //GPIO_Init(LSM303DLHC_I2C_SDA_GPIO_PORT, &GPIO_InitStructure);
  pal_lld_writepad(GPIOB, LSM303DLHC_I2C_SDA_PIN, GPIO_BSRR_BS_7);
  ...
  _pal_lld_setgroupmode(GPIOE, LSM303DLHC_DRDY_PIN, 0x01 << MODE_SHIFT);
  _pal_lld_setgroupmode(GPIOE, LSM303DLHC_DRDY_PIN, 0x00 << OTYPE_SHIFT);
  _pal_lld_setgroupmode(GPIOE, LSM303DLHC_DRDY_PIN, 0x00 << PUDR_SHIFT);
  _pal_lld_setgroupmode(GPIOE, LSM303DLHC_DRDY_PIN, 0x03 << OSPEED_SHIFT);
  ...
  pal_lld_writepad(GPIOE,  LSM303DLHC_DRDY_PIN, GPIO_BSRR_BS_2);
  ...
  _pal_lld_setgroupmode(GPIOE, LSM303DLHC_I2C_INT1_PIN, 0x01 << MODE_SHIFT);
  _pal_lld_setgroupmode(GPIOE, LSM303DLHC_I2C_INT1_PIN, 0x00 << OTYPE_SHIFT);
  _pal_lld_setgroupmode(GPIOE, LSM303DLHC_I2C_INT1_PIN, 0x00 << PUDR_SHIFT);
  _pal_lld_setgroupmode(GPIOE, LSM303DLHC_I2C_INT1_PIN, 0x03 << OSPEED_SHIFT);

  pal_lld_writepad(GPIOE, LSM303DLHC_I2C_INT1_PIN, GPIO_BSRR_BS_4);
  pal_lld_writepad(GPIOE, LSM303DLHC_I2C_INT2_PIN, GPIO_BSRR_BS_5);
}  
...
#if 0  
  LSM303DLHC_InitStruct->Power_Mode = 0x00 << 3;    //Normal mode
  LSM303DLHC_InitStruct->AccOutput_DataRate = 0x10; 
  LSM303DLHC_InitStruct->Axes_Enable  = 0x07;
...
{  
  ...
  cra_regm = 0x90;  // temp enabled 15Hz Data Rate  
